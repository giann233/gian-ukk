...
<body>
    <div class="card">
        ...
        @if(session('register_error'))
            <div id="register-error-popup" class="error-popup">
                <div class="error-content">
                    <i class="fas fa-exclamation-triangle"></i>
                    <p>{{ session('register_error') }}</p>
                    <button onclick="closeRegisterErrorPopup()" class="close-btn">OK</button>
                </div>
            </div>
        @endif
        ...
        <p style="font-size: 14px; color: #666; margin-bottom: 25px;">or use your email for registration</p>
        ...
        <div class="switch">
            Already have an account? <a href="{{ route('login.member') }}">Sign In</a>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-show register error popup if exists
            const registerErrorPopup = document.getElementById('register-error-popup');
            if (registerErrorPopup) {
                registerErrorPopup.style.display = 'flex';
            }
        });

        function closeRegisterErrorPopup() {
            const registerErrorPopup = document.getElementById('register-error-popup');
            if (registerErrorPopup) {
                registerErrorPopup.style.display = 'none';
            }
        }
    </script>
</body>
