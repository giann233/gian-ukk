            ...
            <div class="bg-white shadow rounded-lg p-6">
                <form action="{{ route('kategoris.update', $kategori->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_kategori" id="nama_kategori" value="{{ old('nama_kategori', $kategori->nama_kategori) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        @error('nama_kategori')
